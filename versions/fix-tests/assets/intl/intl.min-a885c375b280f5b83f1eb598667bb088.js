...
return s}function O(e){for(var r=0;r<Se.length;++r)if(e.hasOwnProperty(Se[r]))return!1
return!0}function F(e){for(var r=0;r<Fe.length;++r)if(e.hasOwnProperty(Fe[r]))return!1
return!0}function S(e,r){for(var t={_:{}},n=0;n<Fe.length;++n)e[Fe[n]]&&(t[Fe[n]]=e[Fe[n]]),e._[Fe[n]]&&(t._[Fe[n]]=e._[Fe[n]])
for(var a=0;a<Se.length;++a)r[Se[a]]&&(t[Se[a]]=r[Se[a]]),r._[Se[a]]&&(t._[Se[a]]=r._[Se[a]])
...
for(l=0;l<u.length;++l)for(c=0;c<g.length;++c)o="long"===g[c].month?g[c].weekday?e.full:e.long:"short"===g[c].month?e.medium:e.short,(s=S(g[c],u[l])).originalPattern=o,s.extendedPattern=o.replace("{0}",u[l].extendedPattern).replace("{1}",g[c].extendedPattern).replace(/^[,\s]+|[,\s]+$/gi,""),a.push(E(s))
