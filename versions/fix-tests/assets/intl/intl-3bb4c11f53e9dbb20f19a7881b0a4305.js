...
function ge(e){for(var r=0;r<ue.length;++r)if(e.hasOwnProperty(ue[r]))return!1
return!0}function fe(e){for(var r=0;r<ce.length;++r)if(e.hasOwnProperty(ce[r]))return!1
return!0}function me(e,r){for(var t={_:{}},n=0;n<ce.length;++n)e[ce[n]]&&(t[ce[n]]=e[ce[n]]),e._[ce[n]]&&(t._[ce[n]]=e._[ce[n]])
for(var a=0;a<ue.length;++a)r[ue[a]]&&(t[ue[a]]=r[ue[a]]),r._[ue[a]]&&(t._[ue[a]]=r._[ue[a]])
...
for(l=0;l<u.length;++l)for(c=0;c<g.length;++c)o="long"===g[c].month?g[c].weekday?e.full:e.long:"short"===g[c].month?e.medium:e.short,(s=me(g[c],u[l])).originalPattern=o,s.extendedPattern=o.replace("{0}",u[l].extendedPattern).replace("{1}",g[c].extendedPattern).replace(/^[,\s]+|[,\s]+$/gi,""),a.push(ve(s))
